...
// House base + roof — using AI-generated art (house_test.png), skip procedural generation
// To regenerate: run the split script or replace house-base.png / house-roof.png manually

// Cafe base + roof — using AI-generated art (builiding-x.png), skip procedural generation
...
// Bookstore base + roof — using AI-generated art (building-a.png), skip procedural generation
// Market base + roof — using AI-generated art (building-b.png), skip procedural generation

// Bakery base + roof — using AI-generated art (building-c.png), skip procedural generation
{
}
